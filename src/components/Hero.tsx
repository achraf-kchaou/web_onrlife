      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Your AI Coach.<br className="hidden sm:inline" />Your Growth. Your Flow.
            </h1>
            ...
            >
              VYBTOR is the first AI-powered coach for teens. Build focus, confidence, and motivation — while having fun.
            </p>
